...
import (
	...
	"github.com/btwseeu78/workload-sleeper/internal/controller"
...
func init() {
	...
	utilruntime.Must(greenworkloadv1beta1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "0214d5b5.platform.io",
	...
	if err = (&controller.WorkloadScalerReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
		Log:    ctrl.Log.WithName("controllers").WithName("WorkloadScaler"),
	}).SetupWithManager(mgr); err != nil {
